...
public class AndroidPageTest extends BaseTest {
	...
	@Test(priority = 1, dataProviderClass = DataParameters.class, dataProvider = "DP_tc_01_019", groups = { "browser_desktop", "browser_mobile", "native_android", "native_ios" }, enabled = true)
